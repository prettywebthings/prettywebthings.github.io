 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xS="storage";function MS(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new DS(n,s,i,e,Vn)}function LS(){Pt(new yt(xS,MS,"PUBLIC").setMultipleInstances(!0)),Xe(of,lf,""),Xe(of,lf,"esm2017")}LS();function FS(t){return(e,n)=>{const s=a0(e,n).run(()=>Ta(t));gp.set(e,s),u0(s,e)}}function US(t,{firebaseApp:e,modules:n=[]}){t.provide(dp,e);for(const s of n)t.use(s.bind(null,e))}const BS=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n},HS={},$S={class:"flex justify-center items-center h-full"};function jS(t,e){return ka(),Ey("main",$S,"I like rain.")}const WS=BS(HS,[["render",jS]]),D_=aE({history:Cv("/"),routes:[{path:"/",name:"home",component:WS},{path:"/login",component:()=>$o(()=>import("./LoginView-dc6948d8.js"),[])},{path:"/me",name:"me",component:()=>$o(()=>import("./MainLayout-6874b1b5.js"),[]),meta:{title:"Private",requiresAuth:!0},children:[{path:"activity",component:()=>$o(()=>import("./ActivityLog-866fe8fb.js"),[]),meta:{title:"Activity"}}]}]});D_.beforeEach(async t=>{if(t.meta.requiresAuth&&!await c0())return{path:"/login",query:{redirect:t.fullPath}}});const VS="AIzaSyBp2MDQIakiuOUYe0UzJxUB63Z5quZ7Zng",KS="prettywebthings.firebaseapp.com",zS="prettywebthings",qS="prettywebthings.appspot.com",GS="352201092690",YS="1:352201092690:web:cd0118e9f3a4c8e5fdb98b",XS={apiKey:VS,authDomain:KS,projectId:zS,storageBucket:qS,messagingSenderId:GS,appId:YS},JS=Od(XS),No=sv(uE);No.use(US,{firebaseApp:JS,modules:[FS()]});No.use(lv());No.use(D_);No.mount("#app");export{Ht as F,rn as G,BS as _,Pn as a,Ty as b,Ey as c,Ra as d,eA as e,tA as f,MT as g,nA as h,iA as i,sd as j,Ge as k,ka as o,ZS as r,sA as s,QS as t,rA as u,xm as w};
